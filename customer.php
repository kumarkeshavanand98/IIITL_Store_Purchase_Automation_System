				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Indentor Name</label>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-secondary col-sm-4" type="button" onclick="$('#manage-customer').get(0).reset()">Cancel</button>
							</div>
						</div>
					</div>
				</div>

                ...
                <table class="table table-striped table-bordered" id="item-list">
                    <thead>
                        <tr class="bg-navy disabled" style="">
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Product Name</th>
                            ...
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Recommended</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Approved</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Issued</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        if(isset($id)):
                        $order_items_qry = $conn->query("SELECT o.*,i.name, i.description FROM `sales_list` o inner join product_list i on o.id = i.id where o.`id` = '$id' ");
                        $sub_total = 0;
                        ...
                        <td class="align-middle p-1"><?php echo $row['description'] ?></td>
                            <td class="align-middle p-0 text-center"><?php echo $row['qty'] ?></td>
                            <td class="align-middle p-1"><?php echo $row['price'] ?></td>
                            <td class="align-middle p-1 text-right total-price"><?php echo number_format($row['quantity'] * $row['unit_price']) ?></td>
                            <td class="align-middle p-1 "><?php echo $row['recommended'] ?></td>
                            <td class="align-middle p-1 "><?php echo $row['approved'] ?></td>
                            <td class="align-middle p-1 "><?php echo $row['issued'] ?></td>
